...
import { SearchX, PackageOpen, CloudOff, type LucideIcon } from "lucide-react";

type EmptyStateVariant = "no-results" | "no-apps" | "error";
...
const HubEmptyState = memo(({ variant, query, onAction, supportEmail }: HubEmptyStateProps) => {
