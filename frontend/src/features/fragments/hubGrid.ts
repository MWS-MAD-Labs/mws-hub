export const MOBILE_LAUNCHER_SCROLLER_CLASS =
  "min-h-0 flex-1 overflow-y-auto overflow-x-hidden px-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden";

export const MOBILE_LAUNCHER_PAGE_CLASS =
  "grid w-full grid-cols-3 justify-items-center gap-x-5 gap-y-9 px-1 py-6";
