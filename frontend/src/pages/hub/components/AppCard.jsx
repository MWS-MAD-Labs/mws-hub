...
import { ArrowUpRight, Lock, Wrench, Clock3, Unlink } from "lucide-react";
...
const AppCard = memo(({ app, onRequestAccess }) => {
    ...
    return (
        ...
        >
            ...
            {/* Stretched link: the whole tile is the hit target, but it stays a
                real anchor so middle-click and "open in new tab" still work. */}
            {isOpenable &&
                (app.external ? (
                    <a
                        href={app.href}
                    ...
                    <Link to={app.href} className="absolute inset-0 rounded-xl focus:outline-none">
